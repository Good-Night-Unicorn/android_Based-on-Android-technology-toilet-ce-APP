<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="标题内容" prop="biaotineirong">
          <el-input v-model="ruleForm.biaotineirong" 
              placeholder="标题内容" clearable  :readonly="ro.biaotineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="标题内容" prop="biaotineirong">
              <el-input v-model="ruleForm.biaotineirong" 
                placeholder="标题内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
       ...
       this.ruleForm.biaotineirong='坑位清洁'
      }
      // 获取用户信息
      this.$http({
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qingjieshenqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qingjieshenqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
