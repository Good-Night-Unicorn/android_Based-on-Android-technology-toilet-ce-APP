<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公厕名称" prop="gongcemingcheng">
          <el-input v-model="ruleForm.gongcemingcheng" 
              placeholder="公厕名称" clearable  :readonly="ro.gongcemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公厕名称" prop="gongcemingcheng">
              <el-input v-model="ruleForm.gongcemingcheng" 
                placeholder="公厕名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公厕状态" prop="gongcezhuangtai">
          <el-input v-model="ruleForm.gongcezhuangtai" 
              placeholder="公厕状态" clearable  :readonly="ro.gongcezhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公厕状态" prop="gongcezhuangtai">
              <el-input v-model="ruleForm.gongcezhuangtai" 
                placeholder="公厕状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="坑位数量" prop="kengweishuliang">
          <el-input v-model="ruleForm.kengweishuliang" 
              placeholder="坑位数量" clearable  :readonly="ro.kengweishuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="坑位数量" prop="kengweishuliang">
              <el-input v-model="ruleForm.kengweishuliang" 
                placeholder="坑位数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="具体位置" prop="jutiweizhi">
          <el-input v-model="ruleForm.jutiweizhi" 
              placeholder="具体位置" clearable  :readonly="ro.jutiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="具体位置" prop="jutiweizhi">
              <el-input v-model="ruleForm.jutiweizhi" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="消毒情况" prop="xiaoduqingkuang">
          <el-select :disabled="ro.xiaoduqingkuang" v-model="ruleForm.xiaoduqingkuang" placeholder="请选择消毒情况">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="消毒情况" prop="xiaoduqingkuang">
	      <el-input v-model="ruleForm.xiaoduqingkuang"
                placeholder="消毒情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="消毒时间" prop="xiaodushijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiaodushijian" 
                type="date"
                :readonly="ro.xiaodushijian"
                placeholder="消毒时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaodushijian" label="消毒时间" prop="xiaodushijian">
              <el-input v-model="ruleForm.xiaodushijian" 
                placeholder="消毒时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	fengmian : false,
	gongcezhuangtai : false,
	kengweishuliang : false,
	jutiweizhi : false,
	quyu : false,
	xiaoduqingkuang : false,
	xiaodushijian : false,
  ...
  created() {
	this.ruleForm.xiaodushijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='gongcezhuangtai'){
            this.ruleForm.gongcezhuangtai = obj[o];
	    this.ro.gongcezhuangtai = true;
            continue;
          }
          if(o=='kengweishuliang'){
            this.ruleForm.kengweishuliang = obj[o];
	    this.ro.kengweishuliang = true;
            continue;
          }
          if(o=='jutiweizhi'){
	    ...
	    this.ro.quyu = true;
          ...
          if(o=='xiaoduqingkuang'){
            this.ruleForm.xiaoduqingkuang = obj[o];
	    this.ro.xiaoduqingkuang = true;
            continue;
          }
          if(o=='xiaodushijian'){
            this.ruleForm.xiaodushijian = obj[o];
	    this.ro.xiaodushijian = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongcexinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongcexinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
